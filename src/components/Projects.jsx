        ...
        >
          {projects.map((project, index) => (
            <motion.div
              ...
              className="flex flex-col h-full rounded-xl overflow-hidden shadow-lg border border-neutral-800 hover:border-secondary/50 transition-all duration-300 bg-gradient-to-b from-primary/90 to-primary"
            >
              ...
              <div className="flex flex-col flex-grow p-6">
                ...
                {/* Action buttons */}
                <div className="flex gap-4 pt-4 mt-auto border-t border-neutral-800">
                  <a
                    href={project.github}
